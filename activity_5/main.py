...
from activity_5.utils import text_preprocessing, get_lemma_from_token, get_base_vector, get_global_idf_lemmas, \
    get_vectors_by_doc, cos, get_sites

tfidf_tokens_db_name = "../activity_4/tfidf_tokens_db.pickle"
tfidf_lemmas_db_name = "../activity_4/tfidf_lemmas_db.pickle"
